...
if (isset($_POST['submit'])) { 
    ...
    $query =  "CALL searchPlayerStats(:player_extended_name)";  //secure way to sanitize the value stored in the player_extended_name
    ...
    <?php
      if (isset($_POST['submit'])) {
        if ($result && $prepared_stmt->rowCount() > 0) { ?>
              ...
              <h2><?php echo $_POST['player_extended_name'];?>'s Stats</h2>
